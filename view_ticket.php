			...
			<div class="card card-outline">
				...
				<div class="card-body">
					<div class="container-fluid">
						<div class="row">
							<div class="col-md-6">
								<label for="" class="control-label border-bottom border-grey">Subject</label>
								<p class="ml-2 d-list"><b><?php echo $subject ?></b></p>
								<label for="" class="control-label border-bottom border-grey">Customer</label>
								<p class="ml-2 d-list"><b><?php echo $cname ?></b></p>
							</div>
							<div class="col-md-6">
								<label for="" class="control-label border-bottom border-grey">Status</label>
								<p class="ml-2 d-list">
									<?php if($status == 0): ?>
								...
								<label for="" class="control-label border-bottom border-grey">Need Support From</label>
